...
#define GAMEPAD_2_Pin GPIO_PIN_2
#define GAMEPAD_2_GPIO_Port GPIOG
#define GAMEPAD_1_Pin GPIO_PIN_3
...
#define GAMEPAD_3_GPIO_Port GPIOD
#define GAMEPAD_4_Pin GPIO_PIN_6
#define GAMEPAD_4_GPIO_Port GPIOD
#define GAMEPAD_5_Pin GPIO_PIN_7
