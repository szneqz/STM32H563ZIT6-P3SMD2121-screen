...
#define DISPLAY_C_Pin GPIO_PIN_0
...
#define GAMEPAD_UP_Pin GPIO_PIN_8
#define GAMEPAD_UP_GPIO_Port GPIOC
#define GAMEPAD_DOWN_Pin GPIO_PIN_9
#define GAMEPAD_DOWN_GPIO_Port GPIOC
...
#define GAMEPAD_LEFT_Pin GPIO_PIN_10
#define GAMEPAD_LEFT_GPIO_Port GPIOC
#define GAMEPAD_RIGHT_Pin GPIO_PIN_11
#define GAMEPAD_RIGHT_GPIO_Port GPIOC
#define GAMEPAD_A_Pin GPIO_PIN_12
#define GAMEPAD_A_GPIO_Port GPIOC
#define DISPLAY_B_Pin GPIO_PIN_0
#define DISPLAY_B_GPIO_Port GPIOD
#define DISPLAY_LATCH_Pin GPIO_PIN_1
#define DISPLAY_LATCH_GPIO_Port GPIOD
#define GAMEPAD_B_Pin GPIO_PIN_2
#define GAMEPAD_B_GPIO_Port GPIOD
